...
const innerCalculatorScreen = document.querySelector(".inner-calculator-screen-display");
let firstOperand = "";
let secondOperand = "";
...
calculatorKeys.addEventListener("click", e => {
  ...
  switch (action) {
    ...
    case "decimal":
      ...
      if (!calculatorScreen.textContent.includes(".")) calculatorScreen.textContent += ".";
      break;
    case "clear":
      clearAll();
      break;
